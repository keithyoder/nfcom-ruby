  ...
  module Webservices
    ...
    class Autorizacao < Base
      ...
      def enviar(xml_assinado)
        ...
        post_soap_with_compression(url: url, action: action, xml: soap_request)

        # Retorna apenas o XML como Nokogiri::XML::Document
